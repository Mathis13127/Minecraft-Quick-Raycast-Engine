...
public class MacroStepValidationTest {
    ...
    static class SimpleVoxelGrid implements IVoxelGrid {
        ...
        final Map<Long, com.pixel.qve.world.Heightmap2D> heightmaps = new HashMap<>();
        ...
        @Override
        public com.pixel.qve.world.Heightmap2D getHeightmap(int chunkX, int chunkZ) {
        ...
        public void setVoxel(int wx, int wy, int wz, boolean solid, int blockId) {
            ...
            if (solid) {
                com.pixel.qve.world.Heightmap2D hm = heightmaps.computeIfAbsent(chunkKey(sx, sz), id -> new com.pixel.qve.world.Heightmap2D());
