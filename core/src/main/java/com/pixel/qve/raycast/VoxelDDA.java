...
public final class VoxelDDA {
     ...
     */
    public static boolean trace(Ray3f ray, IVoxelWorld grid, RayHitResult result) {
    ...
    public static boolean trace(double startX, double startY, double startZ,
                                ...
                                double maxDist, IVoxelWorld grid, RayHitResult result) {
        result.reset();
        ...
        if (startChunkX == endChunkX && startChunkZ == endChunkZ) {
            com.pixel.qve.world.Heightmap2D hm = grid.getHeightmap(startChunkX, startChunkZ);
        ...
        com.pixel.qve.world.VoxelChunkColumn currentColumn = grid.getColumn(currentSx, currentSz);
    ...
    private static boolean evaluateVoxelHit(double startX, double startY, double startZ,
                                           ...
                                           RayHitResult result) {
        com.pixel.qve.state.ShapeRegistry shapeRegistry = grid.getShapeRegistry();
        ...
        com.pixel.qve.state.VoxelShape shape = shapeRegistry.getShape(blockId);
