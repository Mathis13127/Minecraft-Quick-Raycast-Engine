...
/**
 * Cross-platform native off-heap memory cleaner supporting Windows, Linux, and macOS on Java 21+.
 * <p>
 ...
 * </p>
 */
public final class NativeBufferCleaner {

    private static final System.Logger LOGGER = System.getLogger(NativeBufferCleaner.class.getName());
    ...
    public static boolean clean(ByteBuffer buffer) {
        ...
        if (INVOKE_CLEANER_HANDLE != null) {
            try {
                ...
                LOGGER.log(System.Logger.Level.WARNING,
                        "Exception during Unsafe.invokeCleaner: {0}", t.getMessage());
                return false;
            }
        }
        return false;
